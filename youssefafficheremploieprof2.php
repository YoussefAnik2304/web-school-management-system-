...
<div class="main-block container">
    <div class="container" style="height: 640px">
        <div class="home-content">
            <?php
                if (isset($_POST['professeur_id']) && isset($_POST['semestre'])) {
                    $idprofesseur = $_POST['professeur_id'];
                    $semestre = $_POST['semestre'];

                    // Prepare the SQL query
                    $sql = "SELECT date, seance, module FROM emploieprof WHERE professeur = :idprof AND semestre = :semestre";
                    ...
                    echo "Please select a filiere and semestre.";
                }
            ?>
        </div>
    </div>
